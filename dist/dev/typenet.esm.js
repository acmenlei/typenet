...
function getCurrentChildNodes(root) {
    ...
    for (const node of nodes) {
        if (node.nodeType === 3 ||
            (node.nodeType == 1 && node.className != "flicker")) {
    ...
    type(text, options) {
        this.callbacks.push(() => __awaiter(this, void 0, void 0, function* () {
            for (let i = 0, n = text.length; i < n; i++) {
                const textNode = (options === null || options === void 0 ? void 0 : options.style)
                    ? createTextElement(text[i], options === null || options === void 0 ? void 0 : options.style)
